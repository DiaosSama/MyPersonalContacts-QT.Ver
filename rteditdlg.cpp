#include "rteditdlg.h"
#include "ui_rteditdlg.h"
#include"mainwindow.h"
#include"ui_mainwindow.h"
#include"myhead.h"

RtEditDlg::RtEditDlg(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::RtEditDlg)
{
    ui->setupUi(this);
    ...
    ui->generationlineEdit->setText(x.GetInfo());
...
void RtEditDlg::on_yesBtn_clicked()
{
    //编辑保存信息
    if(QMessageBox::information(this,tr("提示"),tr("确定要更改该联系人的信息吗？"),QMessageBox::Yes,QMessageBox::No)==QMessageBox::Yes)
    {
            ...
            school=(ui->generationlineEdit->text()).toStdString();
