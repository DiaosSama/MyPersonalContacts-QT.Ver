#include "tmeditdlg.h"
#include "ui_tmeditdlg.h"
#include"myhead.h"
#include"mainwindow.h"
#include"ui_mainwindow.h"

TmEditDlg::TmEditDlg(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TmEditDlg)
{
    ui->setupUi(this);
    ...
    ui->companylineEdit->setText(x.GetInfo());
...
void TmEditDlg::on_yesBtn_clicked()
{
    //编辑保存信息
    if(QMessageBox::information(this,tr("提示"),tr("确定要更改该联系人的信息吗？"),QMessageBox::Yes,QMessageBox::No)==QMessageBox::Yes)
    {
            ...
            school=(ui->companylineEdit->text()).toStdString();
